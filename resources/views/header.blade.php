  ...
  <div class="container">
      <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <ul class="nav nav-pills">
          ...
          <li class="nav-item"><a href="{{ route('users.create') }}" class="nav-link">Registrarse</a></li>
          <li class="nav-item"><a href="{{ route('showLogin') }}" class="nav-link">Iniciar Sesion</a></li>
        </ul>
      </header>
  </div>
</section>